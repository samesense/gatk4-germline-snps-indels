...
String gatk_docker = "gcr.io/arcus-jpe-pipe-stage-4f4279cc/gatk-nightly:2019-05-07-4.1.2.0-5-g53d015e4f-NIGHTLY-SNAPSHOT"
}
...
String gatk_docker = "gcr.io/arcus-jpe-pipe-stage-4f4279cc/gatk:4.1.4.0"
}
...
String gatk_docker = "gcr.io/arcus-jpe-pipe-stage-4f4279cc/gnarly_genotyper:fixNegativeRefCount"
}
...
Int disk_size
String gatk_docker = "gcr.io/arcus-jpe-pipe-stage-4f4279cc/gatk4-joint-genotyping:1.3.0-1527875152"
}
...
String picard_docker = "gcr.io/arcus-jpe-pipe-stage-4f4279cc/gatk4-joint-genotyping:yf_fire_crosscheck_picard_with_nio_fast_fail_fast_sample_map"
}
